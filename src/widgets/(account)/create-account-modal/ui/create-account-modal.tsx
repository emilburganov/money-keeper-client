import { StoreAccountSchema } from "@/entities/account";
import { useCurrencyStore } from "@/entities/currency";
import { CreateAccountButton } from "@/features/(account)";
			...
			<Modal isOpen={isOpen} onClose={onClose} isCentered size="sm">
				...
				<ModalContent maxW={{ base: "calc(100% - 32px)", sm: 400 }}>
					<ModalHeader pt={5} px={5} pb={0}>
						{t("pages.accounts.createModal.form.title")}
					</ModalHeader>
						...
						>
							<Stack spacing={4}>
								<FormControl isInvalid={!!errors.title?.message}>
									<FormLabel>
										{t("pages.accounts.createModal.form.fields.title")}:
									</FormLabel>
									<Input
										{...register("title")}
										type="text"
										...
										placeholder={t(
											"pages.accounts.createModal.form.placeholders.title",
										)}
									/>
									{errors.title && (
