...
import { LoginCredentials, RegistrationCredentials, TokenResponse, UpdateUserCredentials, User, } from "./models";
...
export const registration = (credentials: RegistrationCredentials): Promise<TokenResponse> => {
...
export const updateUser = (credentials: UpdateUserCredentials | FormData): Promise<User> => {
